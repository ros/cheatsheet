...
\includegraphics[width=.75\columnwidth]{rqt.png}
\begin{tabbing}
Us\=age:\\
...
\includegraphics[width=.75\columnwidth]{rqt_graph.png}
\begin{tabbing}
Us\=age:\\
\> \texttt{\$ rqt\_graph}\\
\end{tabbing}
...
\vspace{2.5 mm}
\includegraphics[width=.75\columnwidth]{rqt_plot.png}
\begin{tabbing}
E\=x\=amples:\\
...
\vspace{2.5 mm}
\includegraphics[width=.75\columnwidth]{rqt_bag.png}
\begin{tabbing}
Us\=age:\\
...
\vspace{2.5 mm}
\includegraphics[width=.75\columnwidth]{rqt_console.png}
\begin{tabbing}
Us\=age:\\
\> \texttt{\$ rqt\_console}\\
\end{tabbing}
...
\subsection{\href{http://wiki.ros.org/catkin/Tutorials/create\_a\_workspace}{catkin\_init\_workspace}}
A tool to create a workspace for catkin.
\vspace{2.5 mm}
\begin{tabbing}
E\=x\=amples:\\
\> \texttt{\$ source /opt/ros/hydro/setup.bash}\\
\> \texttt{\$ mkdir -p ~/catkin\_ws/src}\\
\> \texttt{\$ cd ~/catkin\_ws/src}\\
...
\begin{tabbing}
U\=sage:\\
\> \texttt{\$ catkin\_create\_pkg <package\_name> [depend1] [depend2] [depend3]}\\
\end{tabbing}
\begin{tabbing}
E\=x\=amples:\\
\> \texttt{\$ cd ~/catkin\_ws/src}\\
...
\> \texttt{\$ cd ~/catkin\_ws/src}\\
\> \texttt{\$ wstool init}\\
\> \texttt{\$ wstool set ros\_tutorials --git  git://github.com/ros/ros\_tutorials.git}\\
\> \texttt{\$ wstool update}\\
\end{tabbing}
