...
Qt-based framework for ROS that can run all the \href{http://wiki.ros.org/rqt/Plugins}{existing GUI tools} as dockable windows within rqt --even \href{http://wiki.ros.org/rviz}{rviz}
